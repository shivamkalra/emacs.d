...
#+BEGIN_SRC emacs-lisp
  ...
  ;; TODO: Move linum and hlinum to better places
  ;; setup linum
  (use-package linum
        :config
...
#+BEGIN_SRC emacs-lisp
  (defun sk/projectile-action ()
    "Open `dired' and change root directory of `neotree' to project's
  root directory.'"
    (interactive)
    (let ((project-root (projectile-project-root)))
      (neotree-dir project-root)
      (neotree-change-root project-root)
      (dired project-root)))
  ...
  (use-package projectile
    ...
    :config
    (progn
      (setq projectile-switch-project-action 'sk/projectile-action)
